...
@author: dlemel
'''
from dictionaries import KeyWordsStealerWithFilter
...
class KeywordsGenerator:
    def run(self, context, run_time):     
		...
		max_num_world = round(run_time / float(len(context)) * 6) #if max_num_world < 10: raise Exception("not enough time")
		world = list()
